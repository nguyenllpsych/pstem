...
# data and dictionary
dat <- readRDS("../PSTEM_Wave_2_WORKING_SCORED_2023-03-29.RData")
colnames(dat)
...
# stemre and stemci items not yet scored
# waiting for results of dimensionality analyses
...
dat[c(8, 48, 105, 113, 129, 132), "gender_f"] <- "woman"
dat[c(53,88), "gender_f"] <- NA
...
# IV. EXPORT ======================
saveRDS(dat, file = "../PSTEM_Wave_2_SCORED_2023-03-29.RData")
rio::export(dat, file = "../PSTEM_Wave_2_SCORED_2023-03-29.csv")
rio::export(dat, file = "../PSTEM_Wave_2_SCORED_2023-03-29.sav")
